...
const darkBackground = '#201414';
const primaryText = '#e6eb00';
    ...
    palette: {
        ...
        ...(mode === 'light'
            ...
            : {
                ...
                text: {
                    primary: primaryText,
                    secondary: '#e6eb00', // A muted secondary text color
                    disabled: '#e6eb00', // A light grey for disabled text
                },
                primary: {
                    light: '#e6eb00', // A lighter shade of green
                    main: primaryText,
                    dark: '#e6eb00', // A darker shade of green
